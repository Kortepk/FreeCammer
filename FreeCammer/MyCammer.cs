...
namespace FreeCammer
{
    ...
    public class MyCammer : BaseUnityPlugin
    {
        ...
        public const string modVersion = "0.1.2.5";
        ...
        public void Awake()
        {
            ...
            rotationSmoothTime = Config.Bind("General", "Smoothing rotation time", 0.4f, " The duration in seconds that the camera takes to smoothly transition from one angle to another. A shorter value results in sharper, more immediate camera movements, while a longer value provides a smoother, more gradual rotation.\n Value >= 0");
