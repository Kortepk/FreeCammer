...
namespace FreeCammer
{
    ...
    public class MyCammer : BaseUnityPlugin
    {
        ...
        public const string modVersion = "0.1.3.0";
        ...
        public static ConfigEntry<float> moveSmoothTime;    // Time to reach target position
        ...
        public void Awake()
        {
            ...
            rotationSmoothTime = Config.Bind("General", "Smoothing rotation time", 0.5f, " The duration in seconds that the camera takes to smoothly transition from one angle to another. A shorter value results in sharper, more immediate camera movements, while a longer value provides a smoother, more gradual rotation.\n Value >= 0");
            moveSmoothTime = Config.Bind("General", "Smoothing move time", 0.5f, "The duration in seconds for the camera to smoothly accelerate during movement. A shorter value results in quicker, more responsive movements, while a longer value allows for smoother transitions.\n Value >= 0");
